...
import Erdos1038.HighKPlatformAffineCorrectionCertificateCap288
import Erdos1038.HighKPlatformAffineCornerPrefactorChunk219
import Erdos1038.HighKPlatformAffineCornerPenaltyChunk219
import Erdos1038.HighKPlatformAffineCornerSincGapChunk219
...
namespace Erdos1038.HighKPlatformAffineTableChunk219
...
theorem raw_219 : RawChecks (data ⟨219, by decide⟩) := by
  ...
  · apply uniformPositive_affineCorner_of_lower_components
      (prefactorLower := prefactorLower_219)
      (qCorrectionLower := cap288CorrectionLower)
      (rCorrectionLower := cap170CorrectionLower)
      (penaltyLower := penaltyLower_219)
      (sincGapLower := sincGapLower_219)
    · exact prefactor_219
    · apply uniformLower_of_evalLower
      change EvalLower (data ⟨219, by decide⟩).boxes
        (circleCorrectionLowerE scalarLogTerms scalarTrigDoubles
          scalarFourierTerms (.rat (288 / 100)) piE)
        cap288CorrectionLower
      exact cap288Correction (data ⟨219, by decide⟩)
    · apply uniformLower_of_evalLower
      change EvalLower (data ⟨219, by decide⟩).boxes
        (circleCorrectionLowerE scalarLogTerms scalarTrigDoubles
          scalarFourierTerms (.rat (170 / 100)) piE)
        cap170CorrectionLower
      exact cap170Correction (data ⟨219, by decide⟩)
    · exact penalty_219
    · exact sincGap_219
    · kernel_decide
  -- r_eval
...
end Erdos1038.HighKPlatformAffineTableChunk219
