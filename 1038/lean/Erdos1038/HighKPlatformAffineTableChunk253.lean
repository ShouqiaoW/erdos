...
import Erdos1038.HighKPlatformAffineCorrectionCertificateCap284
import Erdos1038.HighKPlatformAffineCornerPrefactorChunk253
import Erdos1038.HighKPlatformAffineCornerPenaltyChunk253
import Erdos1038.HighKPlatformAffineCornerSincGapChunk253
...
namespace Erdos1038.HighKPlatformAffineTableChunk253
...
theorem raw_253 : RawChecks (data ⟨253, by decide⟩) := by
  ...
  · apply uniformPositive_affineCorner_of_lower_components
      (prefactorLower := prefactorLower_253)
      (qCorrectionLower := cap284CorrectionLower)
      (rCorrectionLower := cap172CorrectionLower)
      (penaltyLower := penaltyLower_253)
      (sincGapLower := sincGapLower_253)
    · exact prefactor_253
    · apply uniformLower_of_evalLower
      change EvalLower (data ⟨253, by decide⟩).boxes
        (circleCorrectionLowerE scalarLogTerms scalarTrigDoubles
          scalarFourierTerms (.rat (284 / 100)) piE)
        cap284CorrectionLower
      exact cap284Correction (data ⟨253, by decide⟩)
    · apply uniformLower_of_evalLower
      change EvalLower (data ⟨253, by decide⟩).boxes
        (circleCorrectionLowerE scalarLogTerms scalarTrigDoubles
          scalarFourierTerms (.rat (172 / 100)) piE)
        cap172CorrectionLower
      exact cap172Correction (data ⟨253, by decide⟩)
    · exact penalty_253
    · exact sincGap_253
    · kernel_decide
  -- r_eval
...
end Erdos1038.HighKPlatformAffineTableChunk253
