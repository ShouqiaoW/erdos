...
/-! # Expanded statement audit for the concrete paper-bank application -/

open scoped BigOperators

namespace Erdos390.WholePaper.BankPaperExactificationApplicationStatementAudit
...
example
  ...
  exact bankPaper_guarded_integral_exactification
    row rowSignature hrowSignatureInj value n M Y x fixed R hMThree
    hvalueInj hvaluePos hvalueLe hx hrowInt hsignature hcertificate
    hfixedPositive hfixedCandidate hfixedBank hcandidateBank hY

end

end Erdos390.WholePaper.BankPaperExactificationApplicationStatementAudit
